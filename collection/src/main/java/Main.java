...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Время удалить группу ArrayList() = " + removeList(array));
    ...
    public static long removeList(List<Integer> collection) {
        long start = System.currentTimeMillis();
        System.out.println(collection.size());
        collection.removeAll(collection.subList(0, 10_000));
        long end = System.currentTimeMillis() - start;
        System.out.println(collection.size());
